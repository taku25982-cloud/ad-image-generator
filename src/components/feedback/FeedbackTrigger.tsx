...
export function FeedbackTrigger() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-[60] group flex items-center gap-2 pointer-events-none">
      {/* ツールチップ的なラベル */}
      ...
      <button
        ...
        className="relative w-14 h-14 flex items-center justify-center focus:outline-none pointer-events-auto"
